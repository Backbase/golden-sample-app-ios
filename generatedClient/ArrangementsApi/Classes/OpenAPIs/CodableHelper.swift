...
open class CodableHelper {
    ...
    open class func decodeDate<T: CodingKey>(from container: KeyedDecodingContainer<T>,
    ...
    open class func decodeDateIfPresent<T: CodingKey>(from container: KeyedDecodingContainer<T>,
                                             forKey: T) throws -> Date? {
    ...
    open class func decodeDateTime<T: CodingKey>(from container: KeyedDecodingContainer<T>,
                                             forKey: T) throws -> Date {
        let dateStr = try container.decode(String.self, forKey: forKey)
    ...
    open class func decodeDateTimeIfPresent<T: CodingKey>(from container: KeyedDecodingContainer<T>,
                                             forKey: T) throws -> Date? {
        guard let dateStr = try container.decodeIfPresent(String.self, forKey: forKey) else {
            return nil
        }
