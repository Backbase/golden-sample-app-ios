...
public struct DebitCard: Codable, Equatable {
    ...
    /// Builder class for DebitCard DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for DebitCard DTO.
        public func build() -> DebitCard {
            return DebitCard(number: number, 
    ...
    public static func ==(lhs: DebitCard, rhs: DebitCard) -> Bool {
        return lhs.number == rhs.number &&
        lhs.urgentTransferAllowed == rhs.urgentTransferAllowed &&
        lhs.cardNumber == rhs.cardNumber &&
        lhs.accountInterestRate == rhs.accountInterestRate &&
