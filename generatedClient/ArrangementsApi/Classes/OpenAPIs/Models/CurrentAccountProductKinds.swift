//
// CurrentAccountProductKinds.swift
//
...
public struct CurrentAccountProductKinds: Codable, Equatable {
    public var products: [CurrentAccount]
    ...
    @available(*, deprecated, message: "This initializer is deprecated, use the initializer and the setters of CurrentAccountProductKinds.Builder class.")
    public init(products: [CurrentAccount], name: String? = nil, aggregatedBalance: SummaryAggregatedBalance? = nil, additions: [String: String]? = nil) {
    ...
    /// Builder class for CurrentAccountProductKinds DTO.
    public final class Builder: Equatable {
        ...
        public init(products: [CurrentAccount]) {
            self.products = products
        }
        ...
        /// Builder initializer method for CurrentAccountProductKinds DTO.
        public func build() -> CurrentAccountProductKinds {
            return CurrentAccountProductKinds(products: products, 
                    name: name, 
    ...
    public init(from decoder: Decoder) throws {
        ...
        products = try container.decode([CurrentAccount].self, forKey: "products")
    ...
    public static func ==(lhs: CurrentAccountProductKinds, rhs: CurrentAccountProductKinds) -> Bool {
        return lhs.products == rhs.products &&
        lhs.name == rhs.name &&
        lhs.aggregatedBalance == rhs.aggregatedBalance &&
        lhs.additions == rhs.additions
