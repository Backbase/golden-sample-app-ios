//
// AbstractSearchAccountsRequest.swift
//
...
/** Contains the parameters needed to search for accounts; at least one parameter must be specified, or the endpoint will raise BadRequest(400). */
public struct AbstractSearchAccountsRequest: Codable, Equatable {
    ...
    @available(*, deprecated, message: "This initializer is deprecated, use the initializer and the setters of AbstractSearchAccountsRequest.Builder class.")
    ...
    /// Builder class for AbstractSearchAccountsRequest DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for AbstractSearchAccountsRequest DTO.
        public func build() -> AbstractSearchAccountsRequest {
            return AbstractSearchAccountsRequest(from: from, 
                    size: size, 
    ...
    public static func ==(lhs: AbstractSearchAccountsRequest, rhs: AbstractSearchAccountsRequest) -> Bool {
        return lhs.from == rhs.from &&
        lhs.size == rhs.size &&
        lhs.identifier == rhs.identifier &&
        lhs.customerId == rhs.customerId &&
