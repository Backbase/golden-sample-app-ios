...
public struct DebitCardProductKinds: Codable, Equatable {
    public var products: [DebitCard]
    ...
    @available(*, deprecated, message: "This initializer is deprecated, use the initializer and the setters of DebitCardProductKinds.Builder class.")
    public init(products: [DebitCard], name: String? = nil, aggregatedBalance: SummaryAggregatedBalance? = nil, additions: [String: String]? = nil) {
    ...
    /// Builder class for DebitCardProductKinds DTO.
    public final class Builder: Equatable {
        ...
        public init(products: [DebitCard]) {
            self.products = products
        }
        ...
        /// Builder initializer method for DebitCardProductKinds DTO.
        public func build() -> DebitCardProductKinds {
            return DebitCardProductKinds(products: products, 
                    name: name, 
    ...
    public init(from decoder: Decoder) throws {
        ...
        products = try container.decode([DebitCard].self, forKey: "products")
    ...
    public static func ==(lhs: DebitCardProductKinds, rhs: DebitCardProductKinds) -> Bool {
        return lhs.products == rhs.products &&
        lhs.name == rhs.name &&
        lhs.aggregatedBalance == rhs.aggregatedBalance &&
        lhs.additions == rhs.additions
