...
public struct AggregatedBalances: Codable, Equatable {
    ...
    @available(*, deprecated, message: "This initializer is deprecated, use the initializer and the setters of AggregatedBalances.Builder class.")
    ...
    /// Builder class for AggregatedBalances DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for AggregatedBalances DTO.
        public func build() -> AggregatedBalances {
            return AggregatedBalances(id: id, 
    ...
    public static func ==(lhs: AggregatedBalances, rhs: AggregatedBalances) -> Bool {
        return lhs.id == rhs.id &&
        lhs.productKindName == rhs.productKindName &&
        lhs.balanceType == rhs.balanceType &&
        lhs.numberOfArrangements == rhs.numberOfArrangements &&
