...
public struct ExternalProductItem: Codable, Equatable {
    ...
    public var productKind: ExternalProductKindItem?
    public var additions: [String: String]?

    @available(*, deprecated, message: "This initializer is deprecated, use the initializer and the setters of ExternalProductItem.Builder class.")
    public init(externalId: String? = nil, externalTypeId: String? = nil, typeName: String? = nil, productKind: ExternalProductKindItem? = nil, additions: [String: String]? = nil) {
    ...
    /// Builder class for ExternalProductItem DTO.
    public final class Builder: Equatable {
        ...
        public private(set) var productKind: ExternalProductKindItem?
        ...
        public func set(productKind: ExternalProductKindItem?) -> Self {
            self.productKind = productKind
            return self
        }
        ...
        /// Builder initializer method for ExternalProductItem DTO.
        public func build() -> ExternalProductItem {
            return ExternalProductItem(externalId: externalId, 
    ...
    public init(from decoder: Decoder) throws {
        ...
        productKind = try container.decodeIfPresent(ExternalProductKindItem.self, forKey: "productKind")
        additions = try container.decodeIfPresent([String: String].self, forKey: "additions")
    }

    public static func ==(lhs: ExternalProductItem, rhs: ExternalProductItem) -> Bool {
        return lhs.externalId == rhs.externalId &&
        lhs.externalTypeId == rhs.externalTypeId &&
        lhs.typeName == rhs.typeName &&
        lhs.productKind == rhs.productKind &&
