...
public struct SavingsAccount: Codable, Equatable {
    ...
    /// Builder class for SavingsAccount DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for SavingsAccount DTO.
        public func build() -> SavingsAccount {
            return SavingsAccount(bookedBalance: bookedBalance, 
    ...
    public static func ==(lhs: SavingsAccount, rhs: SavingsAccount) -> Bool {
        return lhs.bookedBalance == rhs.bookedBalance &&
        lhs.availableBalance == rhs.availableBalance &&
        lhs.accruedInterest == rhs.accruedInterest &&
        lhs.IBAN == rhs.IBAN &&
