...
public struct TermDeposit: Codable, Equatable {
    ...
    /// Builder class for TermDeposit DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for TermDeposit DTO.
        public func build() -> TermDeposit {
            return TermDeposit(bookedBalance: bookedBalance, 
    ...
    public static func ==(lhs: TermDeposit, rhs: TermDeposit) -> Bool {
        return lhs.bookedBalance == rhs.bookedBalance &&
        lhs.principalAmount == rhs.principalAmount &&
        lhs.accruedInterest == rhs.accruedInterest &&
        lhs.IBAN == rhs.IBAN &&
