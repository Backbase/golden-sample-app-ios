...
public struct CardDetails: Codable, Equatable {
    ...
    @available(*, deprecated, message: "This initializer is deprecated, use the initializer and the setters of CardDetails.Builder class.")
    ...
    /// Builder class for CardDetails DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for CardDetails DTO.
        public func build() -> CardDetails {
            return CardDetails(cardProvider: cardProvider, 
                    secured: secured, 
    ...
    public static func ==(lhs: CardDetails, rhs: CardDetails) -> Bool {
        return lhs.cardProvider == rhs.cardProvider &&
        lhs.secured == rhs.secured &&
        lhs.availableCashCredit == rhs.availableCashCredit &&
        lhs.cashCreditLimit == rhs.cashCreditLimit &&
