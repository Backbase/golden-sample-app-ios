//
// InvestmentAccountProductKinds.swift
//
...
public struct InvestmentAccountProductKinds: Codable, Equatable {
    public var products: [InvestmentAccount]
    ...
    @available(*, deprecated, message: "This initializer is deprecated, use the initializer and the setters of InvestmentAccountProductKinds.Builder class.")
    public init(products: [InvestmentAccount], name: String? = nil, aggregatedBalance: SummaryAggregatedBalance? = nil, additions: [String: String]? = nil) {
    ...
    /// Builder class for InvestmentAccountProductKinds DTO.
    public final class Builder: Equatable {
        ...
        public init(products: [InvestmentAccount]) {
            self.products = products
        }
        ...
        /// Builder initializer method for InvestmentAccountProductKinds DTO.
        public func build() -> InvestmentAccountProductKinds {
            return InvestmentAccountProductKinds(products: products, 
                    name: name, 
    ...
    public init(from decoder: Decoder) throws {
        ...
        products = try container.decode([InvestmentAccount].self, forKey: "products")
    ...
    public static func ==(lhs: InvestmentAccountProductKinds, rhs: InvestmentAccountProductKinds) -> Bool {
        return lhs.products == rhs.products &&
        lhs.name == rhs.name &&
        lhs.aggregatedBalance == rhs.aggregatedBalance &&
        lhs.additions == rhs.additions
