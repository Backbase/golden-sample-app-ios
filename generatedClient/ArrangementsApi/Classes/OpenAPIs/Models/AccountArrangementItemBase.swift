//
// AccountArrangementItemBase.swift
//
...
public struct AccountArrangementItemBase: Codable, Equatable {
    ...
    /// Builder class for AccountArrangementItemBase DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for AccountArrangementItemBase DTO.
        public func build() -> AccountArrangementItemBase {
            return AccountArrangementItemBase(displayName: displayName, 
    ...
    public static func ==(lhs: AccountArrangementItemBase, rhs: AccountArrangementItemBase) -> Bool {
        return lhs.displayName == rhs.displayName &&
        lhs.debitCards == rhs.debitCards &&
        lhs.unmaskableAttributes == rhs.unmaskableAttributes &&
        lhs.name == rhs.name &&
