...
public struct BaseProduct: Codable, Equatable {
    ...
    @available(*, deprecated, message: "This initializer is deprecated, use the initializer and the setters of BaseProduct.Builder class.")
    public init(id: String? = nil, name: String? = nil, displayName: String? = nil, externalTransferAllowed: Bool? = nil, crossCurrencyAllowed: Bool? = nil, productKindName: String? = nil, productTypeName: String? = nil, bankAlias: String? = nil, sourceId: String? = nil, visible: Bool? = nil, accountOpeningDate: Date? = nil, lastUpdateDate: Date? = nil, userPreferences: UserPreferences? = nil, state: StateItem? = nil, parentId: String? = nil, subArrangements: [BaseProduct]? = nil, financialInstitutionId: Int64? = nil, lastSyncDate: Date? = nil, cardDetails: CardDetails? = nil, interestDetails: InterestDetails? = nil, reservedAmount: Double? = nil, remainingPeriodicTransfers: Double? = nil, bankBranchCode2: String? = nil, nextClosingDate: Date? = nil, overdueSince: Date? = nil, credentialsExpired: Bool? = nil, externalAccountStatus: String? = nil, additions: [String: String]? = nil) {
        self.id = id
        self.name = name
    ...
    /// Builder class for BaseProduct DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for BaseProduct DTO.
        public func build() -> BaseProduct {
            return BaseProduct(id: id, 
                    name: name, 
    ...
    public static func ==(lhs: BaseProduct, rhs: BaseProduct) -> Bool {
        return lhs.id == rhs.id &&
        lhs.name == rhs.name &&
        lhs.displayName == rhs.displayName &&
        lhs.externalTransferAllowed == rhs.externalTransferAllowed &&
