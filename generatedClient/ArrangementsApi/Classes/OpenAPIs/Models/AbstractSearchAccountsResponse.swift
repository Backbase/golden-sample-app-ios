//
// AbstractSearchAccountsResponse.swift
//
...
public struct AbstractSearchAccountsResponse: Codable, Equatable {
    ...
    @available(*, deprecated, message: "This initializer is deprecated, use the initializer and the setters of AbstractSearchAccountsResponse.Builder class.")
    ...
    /// Builder class for AbstractSearchAccountsResponse DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for AbstractSearchAccountsResponse DTO.
        public func build() -> AbstractSearchAccountsResponse {
            return AbstractSearchAccountsResponse(externalId: externalId, 
                    name: name, 
                    IBAN: IBAN, 
                    BBAN: BBAN, 
                    BIC: BIC, 
    ...
    public static func ==(lhs: AbstractSearchAccountsResponse, rhs: AbstractSearchAccountsResponse) -> Bool {
        return lhs.externalId == rhs.externalId &&
        lhs.name == rhs.name &&
        lhs.IBAN == rhs.IBAN &&
        lhs.BBAN == rhs.BBAN &&
