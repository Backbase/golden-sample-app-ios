//
// AccountLinkedArrangementItem.swift
//
...
public struct AccountLinkedArrangementItem: Codable, Equatable {
    /** Indicator if arrangement is already linked to a legal entity  */
    ...
    /// Builder class for AccountLinkedArrangementItem DTO.
    public final class Builder: Equatable {
        ...
        /// Setter method for linked property.
        public func set(linked: Bool?) -> Self {
            self.linked = linked
            return self
        }
        ...
        /// Builder initializer method for AccountLinkedArrangementItem DTO.
        public func build() -> AccountLinkedArrangementItem {
            return AccountLinkedArrangementItem(linked: linked, 
    ...
    public static func ==(lhs: AccountLinkedArrangementItem, rhs: AccountLinkedArrangementItem) -> Bool {
        return lhs.linked == rhs.linked &&
        lhs.legalEntityIds == rhs.legalEntityIds &&
        lhs.product == rhs.product &&
        lhs.externalArrangementId == rhs.externalArrangementId &&
