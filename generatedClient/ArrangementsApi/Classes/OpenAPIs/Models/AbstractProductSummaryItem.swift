//
// AbstractProductSummaryItem.swift
//
...
public struct AbstractProductSummaryItem: Codable, Equatable {
    ...
    /// Builder class for AbstractProductSummaryItem DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for AbstractProductSummaryItem DTO.
        public func build() -> AbstractProductSummaryItem {
            return AbstractProductSummaryItem(externalArrangementId: externalArrangementId, 
        ...
        public static func ==(lhs: Builder, rhs: Builder) -> Bool {
            return lhs.externalArrangementId == rhs.externalArrangementId &&
    ...
    public static func ==(lhs: AbstractProductSummaryItem, rhs: AbstractProductSummaryItem) -> Bool {
        return lhs.externalArrangementId == rhs.externalArrangementId &&
        lhs.externalLegalEntityId == rhs.externalLegalEntityId &&
        lhs.externalProductId == rhs.externalProductId &&
        lhs.bookedBalance == rhs.bookedBalance &&
