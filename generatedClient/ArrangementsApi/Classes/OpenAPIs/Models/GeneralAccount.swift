...
public struct GeneralAccount: Codable, Equatable {
    ...
    @available(*, deprecated, message: "This initializer is deprecated, use the initializer and the setters of GeneralAccount.Builder class.")
    public init(bookedBalance: String? = nil, availableBalance: String? = nil, creditLimit: String? = nil, IBAN: String? = nil, BBAN: String? = nil, BIC: String? = nil, currency: String? = nil, urgentTransferAllowed: Bool? = nil, bankBranchCode: String? = nil, accountInterestRate: Double? = nil, valueDateBalance: Double? = nil, creditLimitUsage: Double? = nil, creditLimitInterestRate: Double? = nil, creditLimitExpiryDate: Date? = nil, accruedInterest: Double? = nil, debitCardsItems: [DebitCardItem], startDate: Date? = nil, minimumRequiredBalance: Double? = nil, accountHolderAddressLine1: String? = nil, accountHolderAddressLine2: String? = nil, accountHolderStreetName: String? = nil, town: String? = nil, postCode: String? = nil, countrySubDivision: String? = nil, accountHolderNames: String? = nil, accountHolderCountry: String? = nil, number: String? = nil, cardNumber: Double? = nil, creditCardAccountNumber: String? = nil, validThru: Date? = nil, applicableInterestRate: Double? = nil, remainingCredit: Double? = nil, outstandingPayment: Double? = nil, minimumPayment: Double? = nil, minimumPaymentDueDate: Date? = nil, currentInvestmentValue: String? = nil, productNumber: String? = nil, principalAmount: Double? = nil, termUnit: TimeUnit? = nil, termNumber: Double? = nil, outstandingPrincipalAmount: Double? = nil, monthlyInstalmentAmount: Double? = nil, amountInArrear: Double? = nil, interestSettlementAccount: String? = nil, maturityDate: Date? = nil, maturityAmount: Double? = nil, autoRenewalIndicator: Bool? = nil, interestPaymentFrequencyUnit: TimeUnit? = nil, interestPaymentFrequencyNumber: Double? = nil, creditAccount: Bool? = nil, debitAccount: Bool? = nil, unmaskableAttributes: [MaskableAttribute]? = nil, id: String? = nil, name: String? = nil, displayName: String? = nil, externalTransferAllowed: Bool? = nil, crossCurrencyAllowed: Bool? = nil, productKindName: String? = nil, productTypeName: String? = nil, bankAlias: String? = nil, sourceId: String? = nil, visible: Bool? = nil, accountOpeningDate: Date? = nil, lastUpdateDate: Date? = nil, userPreferences: UserPreferences? = nil, state: StateItem? = nil, parentId: String? = nil, subArrangements: [BaseProduct]? = nil, financialInstitutionId: Int64? = nil, lastSyncDate: Date? = nil, cardDetails: CardDetails? = nil, interestDetails: InterestDetails? = nil, reservedAmount: Double? = nil, remainingPeriodicTransfers: Double? = nil, bankBranchCode2: String? = nil, nextClosingDate: Date? = nil, overdueSince: Date? = nil, credentialsExpired: Bool? = nil, externalAccountStatus: String? = nil, additions: [String: String]? = nil) {
    ...
    /// Builder class for GeneralAccount DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for GeneralAccount DTO.
        public func build() -> GeneralAccount {
            return GeneralAccount(bookedBalance: bookedBalance, 
    ...
    public static func ==(lhs: GeneralAccount, rhs: GeneralAccount) -> Bool {
        return lhs.bookedBalance == rhs.bookedBalance &&
        lhs.availableBalance == rhs.availableBalance &&
        lhs.creditLimit == rhs.creditLimit &&
        lhs.IBAN == rhs.IBAN &&
