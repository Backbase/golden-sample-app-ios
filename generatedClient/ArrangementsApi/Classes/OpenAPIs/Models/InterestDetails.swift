...
public struct InterestDetails: Codable, Equatable {
    ...
    @available(*, deprecated, message: "This initializer is deprecated, use the initializer and the setters of InterestDetails.Builder class.")
    ...
    /// Builder class for InterestDetails DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for InterestDetails DTO.
        public func build() -> InterestDetails {
            return InterestDetails(lastYearAccruedInterest: lastYearAccruedInterest, 
    ...
    public static func ==(lhs: InterestDetails, rhs: InterestDetails) -> Bool {
        return lhs.lastYearAccruedInterest == rhs.lastYearAccruedInterest &&
        lhs.dividendWithheldYTD == rhs.dividendWithheldYTD &&
        lhs.annualPercentageYield == rhs.annualPercentageYield &&
        lhs.cashAdvanceInterestRate == rhs.cashAdvanceInterestRate &&
