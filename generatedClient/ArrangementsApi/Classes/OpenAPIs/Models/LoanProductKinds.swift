...
public struct LoanProductKinds: Codable, Equatable {
    public var products: [Loan]
    ...
    @available(*, deprecated, message: "This initializer is deprecated, use the initializer and the setters of LoanProductKinds.Builder class.")
    public init(products: [Loan], name: String? = nil, aggregatedBalance: SummaryAggregatedBalance? = nil, additions: [String: String]? = nil) {
    ...
    /// Builder class for LoanProductKinds DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for LoanProductKinds DTO.
        public func build() -> LoanProductKinds {
            return LoanProductKinds(products: products, 
                    name: name, 
    ...
    public init(from decoder: Decoder) throws {
        ...
        products = try container.decode([Loan].self, forKey: "products")
    ...
    public static func ==(lhs: LoanProductKinds, rhs: LoanProductKinds) -> Bool {
        return lhs.products == rhs.products &&
        lhs.name == rhs.name &&
        lhs.aggregatedBalance == rhs.aggregatedBalance &&
        lhs.additions == rhs.additions
