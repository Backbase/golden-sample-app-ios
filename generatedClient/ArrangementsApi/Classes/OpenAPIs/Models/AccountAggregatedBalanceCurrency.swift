//
// AccountAggregatedBalanceCurrency.swift
//
...
public struct AccountAggregatedBalanceCurrency: Codable, Equatable {
    ...
    @available(*, deprecated, message: "This initializer is deprecated, use the initializer and the setters of AccountAggregatedBalanceCurrency.Builder class.")
    ...
    /// Builder class for AccountAggregatedBalanceCurrency DTO.
    public final class Builder: Equatable {
        ...
        /// Builder initializer method for AccountAggregatedBalanceCurrency DTO.
        public func build() -> AccountAggregatedBalanceCurrency {
            return AccountAggregatedBalanceCurrency(numberOfArrangements: numberOfArrangements, 
                    amount: amount, 
    ...
    public static func ==(lhs: AccountAggregatedBalanceCurrency, rhs: AccountAggregatedBalanceCurrency) -> Bool {
        return lhs.numberOfArrangements == rhs.numberOfArrangements &&
        lhs.amount == rhs.amount &&
        lhs.currencyCode == rhs.currencyCode &&
        lhs.additions == rhs.additions
