...
**productKindName** | **String** | The label/name that is used for the respective product kind ex. Current Account, Savings Account | [optional] 
...
**legalEntityIds** | **[String]** | References to the legal entities that is are owners of the arrangement. | [optional] 
**productId** | **String** | Reference to the product of which the arrangement is an instantiation. | 
...
**externalProductId** | **String** | A unique identifier for the product that the arrangement applies to | [optional] 
**externalArrangementId** | **String** | A unique external identifier for the arrangement | [optional] 
**userPreferences** | [**AccountUserPreferences**](AccountUserPreferences.md) |  | [optional] 
**product** | [**ExternalProductItem**](ExternalProductItem.md) |  | [optional] 
**state** | [**StateItem**](StateItem.md) |  | [optional] 
**parentId** | **String** | Indicate if the account has parent child relationship with another account | [optional] 
...
**paymentsPastDue** | **Int** | The number of payments that have not been made by the cutoff time at the end of the due date. | [optional] 
...
**debitCards** | [DebitCardItem] |  | [optional] 
