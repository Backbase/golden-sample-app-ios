# AccountLinkedArrangementItem

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**linked** | **Bool** | Indicator if arrangement is already linked to a legal entity  | [optional] 
...
**productId** | **String** | Reference to the product of which the arrangement is an instantiation. This is an external product id. | [optional] 
